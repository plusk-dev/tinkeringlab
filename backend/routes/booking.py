...
from models import MachineBooking, ComponentBooking, WorkstationBooking, session
import datetime
...
async def create_machine_booking(machine_id: int, start: datetime.datetime, end: datetime.datetime, description: str, user=Depends(verify_jwt)):
...
async def create_workstation_booking(workstation_id: int, start: datetime.datetime, end: datetime.datetime, description: str, user=Depends(verify_jwt)):
...
async def create_component_booking(component_id: int, start: datetime.datetime, end: datetime.datetime, description: str, user=Depends(verify_jwt)):
