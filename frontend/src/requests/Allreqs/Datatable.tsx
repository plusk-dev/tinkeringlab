                        ...
                        <SheetContent className="overflow-y-auto">
                          ...
                          <SheetFooter>
                            <div className="flex w-full gap-1">
                              ...
                              <span
                                className={
                                  newItem.approver_id != null && newItem.approved == true ? "default bg-green-500 text-black p-4 w-full text-center rounded-lg border-solid border-2 border-green-800"
                                    : "hidden"
                                }
                              >
                                Accepted
                              ...
                              <span
                                className={
                                  newItem.approver_id != null && newItem.approved == false ? "default bg-red-500 text-black p-4 w-full text-center rounded-lg border-solid border-2 border-red-800"
                                    : "hidden"
                                }
                              >
                                Rejected
