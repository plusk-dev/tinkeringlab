...
export function Person(props:Record<string,any>){
  ...
  return<>
    	<div className={`overflow-visible  relative max-w-sm mx-auto bg-white shadow-2xl ring-1 ring-black/5 rounded-xl ${isSmall?'flex flex-col my-6':'inline-flex items-center gap-6 w-1/3 my-5'}`}>
